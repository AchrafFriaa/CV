...
-----------------------
1. Run start_gui.m
2. Press the button "load image", a path selector will pop-up where you can choose the folder 
containing the image pairs.
3. Press the button "generate disparity" to display the disparity map and the rotation/translation values.

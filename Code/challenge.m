...
% Group members:
members = {'Kevin Rexhepi', 'Jens Ernstberger','Ghassen Laajailia','Lida Kostis','Achraf Friaa'};

% Email-Address (from Moodle!):
mail = {'ga42fuh@mytum.de','ga78duc@mytum.de','ga97paf@mytum.de','ga65vow@mytum.de'};
